...
async def send_message_to_telegram(content: dict) -> None:
    ...
    table = (
        ...
        f"Total: {content['total_point']} (1: {total_bet_0} {get_emoji_for_bet(total_bet_0)}, 2: {total_bet_1} {get_emoji_for_bet(total_bet_1)})\n"
        f"Handicap: {content['handicap_point_0']} (1: {handicap_bet_0} {get_emoji_for_bet(handicap_bet_0)}), {content['handicap_point_1']} (2: {handicap_bet_1} {get_emoji_for_bet(handicap_bet_1)})\n"
